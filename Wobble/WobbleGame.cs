...
namespace Wobble
{
    ...
    public abstract class WobbleGame : Game
    {
        ...
        /// <summary>
        ///     Hook for updating overlays or logic that needs fresh input but needs to run
        ///     before the screen manager (to consume input for example).
        /// </summary>
        /// <param name="gameTime"></param>
        protected virtual void PreScreenManagerUpdate(GameTime gameTime)
        {
        }
